...
const App = () => {
  return (
    <HashRouter>
      ...
      <div className="flex-1 flex flex-col items-center justify-center animate-fade-in bg-gradient-to-br from-white via-gray-100 to-blue-100 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950 min-h-[60vh] w-full transition-colors duration-500">
        <Routes>
          <Route path="/" element={<HelloPageWrapper />} />
...
// Wrappers to ensure only one main landmark exists at the app level
const HelloPageWrapper = () => (
  <main id="main-content" aria-label="Hello page" className="w-full">
    <HelloPage />
  </main>
);

const AboutPageWrapper = () => (
  <main id="main-content" aria-label="About page" className="w-full">
    <AboutPage />
  </main>
);
